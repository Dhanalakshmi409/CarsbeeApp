import 'package:carbeapp/detailpage.dart';
import 'package:carbeapp/detailpage2.dart';
import 'package:carbeapp/detailpage3.dart';
import 'package:carbeapp/detailpage4.dart';
                  ...
                  Container(
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: <Color>[Colors.blue.shade100, Colors.blue]),
                        borderRadius: new BorderRadius.circular(10)),
                    height: 175,
                    width: 125,
                  ...
                  Container(
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: <Color>[Colors.purple.shade100, Colors.purple]),
                        borderRadius: new BorderRadius.circular(10)),
                    height: 175,
                    width: 125,
                    child: GestureDetector(
                  ...
                  Container(
                    decoration: BoxDecoration(
                        gradient: LinearGradient(
                            ...
                            colors: <Color>[Colors.green.shade100, Colors.green]),
                        borderRadius: new BorderRadius.circular(10)),
                    height: 175,
                    width: 125,
                    child: GestureDetector(
